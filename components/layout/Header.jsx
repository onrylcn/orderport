...
import {FaUserAlt, FaShoppingCart, FaSearch, FaWindowClose} from "react-icons/fa";
  ...
  return (
    <div className="h-[5.5rem] bg-secondary">
      ...
      >
            ...
            {isMenuModal && (
                              <button onClick={()=> setIsMenuModal(false)} className="absolute top-4 right-4">
                              <FaWindowClose size={20} className="hover:text-primary transition-all" />
                          </button>
              )}
        </nav>
